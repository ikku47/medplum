...
| Desktop and tablet            | Foundation       | Playwright verifies branded sign-in, authenticated dashboard and protected staff administration without horizontal overflow at 1440x900 and 1024x768; full visit E2E remains |
...
| Appointments          | Available              | Calendar, schedules, slots and appointment management exist; add appointment types and India clinic defaults                                                                                                                                                                              |
| Reception & Queue     | Foundation             | Live day board implements arrival, check-in, vitals, waiting, consultation, billing, completion, cancellation, no-show and left-without-consultation transitions; room assignment and queue E2E remain                                                                                    |
...
| Administration        | Foundation             | Organization/facility, staff invitation/access/deactivation, audit, INR service catalog, reusable clinical forms and care-template visibility exist; departments, rooms and installable specialty packs remain                                                                             |
...
| Consent                    | Next       | FHIR Consent profiles and workflow before any ABDM exchange                                                                                                                                |
...
3. Appointment, check-in, queue, vitals and clinician hand-off.
